#
# Modulmanifest für das Modul "PSBooked"
#
# Generiert von: Tobias Mueller
#
# Generiert am: 20.02.2019
#

@{

    # Die diesem Manifest zugeordnete Skript- oder Binärmoduldatei.
    RootModule         = 'PSBooked.psm1'
    ...
    GUID               = '0bc7348a-98fa-4965-8c8e-e5f7018ca1a0'

    # Autor dieses Moduls
    Author             = 'Tobias Mueller'

    # Unternehmen oder Hersteller dieses Moduls
    CompanyName        = 'Tobias Mueller'

    # Urheberrechtserklärung für dieses Modul
    Copyright          = '(c) 2018 Tobias Mueller. Alle Rechte vorbehalten.'

    # Beschreibung der von diesem Modul bereitgestellten Funktionen
    Description        = 'Powershell Module to interact with the booked  REST API'
    ...
    # FormatsToProcess   = @('xml\PSBooked.Format.ps1xml')
